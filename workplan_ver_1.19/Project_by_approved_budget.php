 ...
 */
    ...
    class Project_by_Approved_BudgetPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset = new QueryDataset(
              ...
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'Project by Approved Budget');
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Project_by_Approved_Budgetssearch', $this->dataset,
                array('project_name', 'approved_budget', 'lead_username'),
                array($this->RenderText('Project Name'), $this->RenderText('Approved Budget'), $this->RenderText('Lead')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Project_by_Approved_Budgetasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        public function Project_by_Approved_BudgetGrid_OnGetCustomTemplate($part, $mode, &$result, &$params)
        {
        if ($part == PagePart::Grid && $mode == PageMode::ViewAll)
          $result = 'budget_by_project.tpl';
        }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Project_by_Approved_BudgetGrid');
            ...
            $result->SetWidth('');
            $this->OnGetCustomTemplate->AddListener('Project_by_Approved_BudgetGrid' . '_OnGetCustomTemplate', $this);
