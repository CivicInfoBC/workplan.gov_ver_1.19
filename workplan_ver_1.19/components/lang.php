...
$cAccessDeniedErrorSuggesstions='You do not have permission to access this page. This could be due to one of several reasons:<ol>
<li>You are not logged in. Go to <a href="%s">login page</a> and try again.</li>
<li>You may not have sufficient privileges to execute operations.</li>
</ol>';
...
$cFullView='<b><a href="{$full_view_link}">FULL VIEW</a></b>';
...
$cErrorsDuringUpdateProcess='An error has occurred during update:';
$cErrorsDuringInsertProcess='An error has occurred during insert:';
$cErrorsDuringDeleteProcess='An error has occurred during delete:';
