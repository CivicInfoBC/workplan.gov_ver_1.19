...
var d = new Date(fieldValues['date_start']);
var n = d.getFullYear();
 
if (fieldValues['year'] < n);

{
  errorInfo.SetMessage('"Start Date must be within the Project Year"');
  return false;
} 
</script>
{/literal}
...
<div class="page-header form-header">
   <h1>{$Grid.Columns.project_name.Value} New Project</h1>
</div>
