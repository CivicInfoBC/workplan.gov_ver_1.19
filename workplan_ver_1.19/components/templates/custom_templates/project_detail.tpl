    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Name', 'Approved Budget', 'Budget Spent'],
        {/literal}
        {foreach item=Row from=$DataGrid.Rows name=RowsGrid}
            ['{$Row.DataCells.project_name.Data}', {$Row.DataCells.approved_budget.Data}, {$Row.DataCells.budget_spent.Data}],
        {/foreach}
        {literal}
        ]);
...
{/literal}
        {foreach item=Row from=$DataGrid.Rows name=RowsGrid}
            '{$Row.DataCells.project_name.Data}'
