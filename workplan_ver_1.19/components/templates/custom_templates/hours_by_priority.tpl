...
data.addRows([
       ...
       var options = {
            title: 'Total Allocated Hours per Priority Item',is3D:true,
    ...
    // when the user mouses over the PieChart, set the selection on the BarChart
    google.visualization.events.addListener(chart1, 'onmouseover', function (e) {
        chart2.setSelection([{column: 1, row: e.row}]);
    });
    // when the user mouses over the BarChart, set the selection on the PieChart
    google.visualization.events.addListener(chart2, 'onmouseover', function (e) {
        chart1.setSelection([{column: null, row: e.row}]);
    });
    // when the user mouses out of the PieChart, clear the selection on the BarChart
    google.visualization.events.addListener(chart1, 'onmouseout', function () {
        chart2.setSelection();
    });
    // when the user mouses out of the BarChart, clear the selection on the PieChart
    google.visualization.events.addListener(chart2, 'onmouseout', function () {
        chart1.setSelection();
    });
