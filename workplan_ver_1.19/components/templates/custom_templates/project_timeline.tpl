	...
	var tasks =  {
      ...
      {/literal}
		{foreach item=Row from=$DataGrid.Rows name=RowsGrid}
               {literal} { {/literal}id:"{$Row.DataCells.project_name.Data}", text:"{$Row.DataCells.project_name.Data}", start_date:"{$Row.DataCells.date_start.Data}", end_date: "{$Row.DataCells.date_end.Data}", progress: "{$Row.DataCells.progress.Data}", open: false{literal}}{/literal},
                {* {literal} { {/literal}id:"{$Row.DataCells.task_name.Data}", text:"{$Row.DataCells.task_name.Data}", start_date:"{$Row.DataCells.task_date_start.Data}",end_date:"{$Row.DataCells.task_date_end.Data}", parent:"{$Row.DataCells.project_name.Data}"{literal}},{/literal} *}
{/foreach}
		 {literal}                
				]
        };
...
{name:"text", label:"Projects", width:200, tree:false}
