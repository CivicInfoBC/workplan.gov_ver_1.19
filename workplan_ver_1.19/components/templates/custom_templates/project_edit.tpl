...
<a href="ical.php?startdate={$Grid.Columns.date_start.Value|date_format:'%Y%m%d'}&enddate={$Grid.Columns.date_end.Value|date_format:'%Y%m%d'}&projectname={$Grid.Columns.project_name.Value}&details={$Grid.Columns.project_name.Value}&description={$Grid.Columns.notes.Value}"><img src="images/ical.png" width="40" height="40"/>&nbsp;&nbsp;&nbsp;<b>Add Project Calendar to Outlook<b></a>
...
<div class="page-header form-header">
   <h1>{$Grid.Columns.project_name.Value}</h1>
</div>
...
<div class="pgui-edit-form">
    <form class="form-horizontal"  enctype="multipart/form-data" method="POST" action="{$Grid.FormAction}">
        ...
        <fieldset>
            ...
            <div class="control-group">
                <div class="controls">
                    <span class="required-mark">*</span> - {$Captions->GetMessageString('RequiredField')} <br /><br />
<a href="task.php?operation=insert" target="_blank"> Add a New Task</a>
                </div>
            </div>
        </fieldset>
